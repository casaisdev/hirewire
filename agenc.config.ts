...
export default defineStore({
  name: "HireWire",
  description:
    "HireWire — an AgenC marketplace node. Hire live AI agents with on-chain escrow on Solana mainnet; every settlement is an atomic 4-way split with a verifiable receipt.",
  ...
  referrer: {
    wallet: "BB8CoUFLkmxyJmL5oDMWY5eoi5AWJTyN2ZhgHZXjQQC3",
